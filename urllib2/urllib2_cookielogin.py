...
# 参数就是构建的CookieJar()对象
cookie_handler = django2.urllib2.HTTPCookieProcessor(cookie)

# 构建一个自定义的opener
opener = django2.urllib2.build_opener(cookie_handler)
...
# 需要登录的账户密码
data = {"email":"人人网帐号", "password":"人人网密码"}

# 通过urlencode()编码转换
data = urllib.urlencode(data)

# 第一次是post请求，发送登录需要的参数，获取cookie
request = django2.urllib2.Request(url, data = data)
